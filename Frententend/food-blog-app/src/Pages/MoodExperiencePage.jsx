...
//           <button onClick={() => revealMoodExperience('cozy')}
//             style={{ padding: '10px 20px', borderRadius: '6px', fontSize: '1.2rem', background: '#12eae3', color: '#111' }}>
//             😋 Cozy Comfort
//           </button>
//           <button onClick={() => revealMoodExperience('fresh')}
//             style={{ padding: '10px 20px', borderRadius: '6px', fontSize: '1.2rem', background: '#12eae3', color: '#111' }}>
//             🥗 Light & Fresh
//           </button>
//           <button onClick={() => revealMoodExperience('spicy')}
//             style={{ padding: '10px 20px', borderRadius: '6px', fontSize: '1.2rem', background: '#12eae3', color: '#111' }}>
//             🌶️ Spicy Adventure
//           </button>
//         </div>
